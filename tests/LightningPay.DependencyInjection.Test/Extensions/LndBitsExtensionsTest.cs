...
{
    public class LndBitsExtensionsTest
    {
        [Fact]
        public void AddLNBitsLightningClient_Should_Add_LNBitsClient()
        {
            ...
            // Act
            serviceCollection.AddLNBitsLightningClient(new Uri("https://lnbits.com/api/"), "apikey");
            var serviceProvider = serviceCollection.BuildServiceProvider();

            // Assert
            var options = serviceProvider.GetService<LNBitsOptions>();
            Assert.NotNull(options);
            Assert.Equal("https://lnbits.com/api/", options.Address.ToString());
        ...
        public void AddLNBitsLightningClient_Should_Add_LNBitsClient_With_Certificate_Options()
        {
            ...
            // Act
            serviceCollection.AddLNBitsLightningClient(new Uri("https://lnbits.com/api/"),
                "apikey",
